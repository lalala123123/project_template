...
print(datetime.now(), "Declaring pipeline: attractions_entity_feature_vector_generation_subgraph_21bc")
@dsl.pipeline(name='attractions_entity_feature_vector_generation_subgraph_21bc', default_compute_target='cpu-cluster')
def attractions_entity_feature_vector_generation_subgraph_21bc(
...
if __name__ == '__main__':
    print(datetime.now(), "Creating attractions_entity_feature_vector_generation_subgraph_21bc")
    pipeline = attractions_entity_feature_vector_generation_subgraph_21bc()
    print(datetime.now(), "Validating")
    pipeline.validate()
    print(datetime.now(), "Saving")
    pipeline._save()
    print(datetime.now(), "Submitting")
    pipeline.submit(experiment_name='attractions_entity_feature_vector_generation_subgraph_21bc')
