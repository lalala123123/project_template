...
print(datetime.now(), "Declaring pipeline: attractions_entity_feature_vector_generation_subgraph_5929")
@dsl.pipeline(name='attractions_entity_feature_vector_generation_subgraph_5929', default_compute_target='cpu-cluster')
def attractions_entity_feature_vector_generation_subgraph_5929(
...
if __name__ == '__main__':
    print(datetime.now(), "Creating attractions_entity_feature_vector_generation_subgraph_5929")
    pipeline = attractions_entity_feature_vector_generation_subgraph_5929()
    print(datetime.now(), "Validating")
    pipeline.validate()
    print(datetime.now(), "Saving")
    pipeline._save()
    print(datetime.now(), "Submitting")
    pipeline.submit(experiment_name='attractions_entity_feature_vector_generation_subgraph_5929')
